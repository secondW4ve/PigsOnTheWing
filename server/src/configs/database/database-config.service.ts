...
export class DatabaseConfigService {
  ...
  get ssl(): boolean {
    return this.configService.get<string>('database.ssl') === 'true';
  }

  get logging(): boolean {
    return this.configService.get<string>('database.logging') === 'true';
  }

  get migrationsRun(): boolean {
    return this.configService.get<string>('database.migrationsRun') === 'true';
  }
}
